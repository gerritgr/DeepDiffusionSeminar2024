...
Small modifications have been made to make it also perform class-conditioned generative deblurring.
...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        self.num_classes = num_classes = config.data.num_classes
